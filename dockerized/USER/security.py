...
# Purpose: JWT OAuth 2.0 security utilities — replaces Flask-Login + werkzeug auth.
#          Supports bcrypt (new) and werkzeug pbkdf2:sha256 (Flask password migration).
# -*- coding: utf-8 -*-
...
def verify_password(plain: str, hashed: str) -> bool:
    """Verify password — supports bcrypt (new) and werkzeug pbkdf2:sha256 (Flask legacy)."""
    try:
